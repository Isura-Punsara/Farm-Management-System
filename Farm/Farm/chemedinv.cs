...
namespace Farm
{
    public partial class chemedinv : Form
    {
        public chemedinv()
        {
            InitializeComponent();
        ...
        private void addmed_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void loaddata()
        {
            ...
            {
                con.Open();
                string sql = "SELECT * FROM MedInventory";
                ...
                meddgv.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            }
        ...
        private void chemedinv_Load(object sender, EventArgs e)
        {
            loaddata();
        }
    }
