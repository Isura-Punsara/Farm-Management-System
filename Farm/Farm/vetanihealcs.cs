...
namespace Farm
{
    public partial class vetanihealcs : Form
    {
        public vetanihealcs()
        {
            InitializeComponent();
        ...
        private void loaddata()
        {
            ...
            {
                con.Open();
                string sql = "SELECT * FROM AniHealTable";
        ...
        private void vetanihealcs_Load(object sender, EventArgs e)
        {
            loaddata();
        }
        ...
        private void sv_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(bid.Text) || string.IsNullOrWhiteSpace(aid.Text) || string.IsNullOrWhiteSpace(note.Text))
            {
            ...
            try
            {
                ...
                string sql = "INSERT INTO AniHealTable (BatchID, AnimalID, Status, Date, Description) VALUES (@bid, @aid, @sts, @date, @note)";
                SqlCommand cmd = new SqlCommand(sql, con);

                cmd.Parameters.AddWithValue("@bid", this.bid.Text);
                cmd.Parameters.AddWithValue("@aid", this.aid.Text);
                cmd.Parameters.AddWithValue("@sts",this.sts.Text);
        ...
        private void vac_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            vetvac vetvac = new vetvac();
            vetvac.Show();
            this.Hide();
