...
namespace Farm
{
    public partial class vettreat : Form
    {
        public vettreat()
        {
            InitializeComponent();
        ...
        private void loaddata()
        {
            ...
            {
                con.Open();
                string sql = "SELECT * FROM TreatTable";
        ...
        private void vettreat_Load(object sender, EventArgs e)
        {
            loaddata();
        }
        ...
        private void sche_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO TreatTable (BatchID, AnimalID, Date, Description) VALUES (@bid, @aid, @date, @note)";
