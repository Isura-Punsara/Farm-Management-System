...
namespace Farm
{
    public partial class vetbredsch : Form
    {
        public vetbredsch()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            {
                con.Open();
                string sql = "SELECT * FROM BredTable";
        ...
        private void sch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO BredTable (ScheduleID, BatchID, Date, Description) VALUES (@sid, @bid, @date, @note)";
        ...
        private void upd_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE BredTable SET Date = @date, BatchID = @bid WHERE ScheduleID = @sid";
                SqlCommand cmd = new SqlCommand(sql, con);
        ...
        private void del_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "DELETE FROM BredTable WHERE ScheduleID = @sid";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.Parameters.AddWithValue("@sid", sid.Text);
        ...
        private void vetbredsch_Load(object sender, EventArgs e)
        {
            LoadData();
        }
    }
