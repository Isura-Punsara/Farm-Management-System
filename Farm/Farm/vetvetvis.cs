...
namespace Farm
{
    public partial class vetvetvis : Form
    {
        public vetvetvis()
        {
            InitializeComponent();
        ...
        private void che_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
        ...
        private void LoadData()
        {
            ...
            {
                con.Open();
                string sql = "SELECT * FROM VisitTable";
        ...
        private void sch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO VisitTable (ScheduleID, BatchID, Date, Description) VALUES (@sid, @bid, @date, @note)";
        ...
        private void upd_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "UPDATE VisitTable SET Date = @date, BatchID = @bid WHERE ScheduleID = @sid";
                SqlCommand cmd = new SqlCommand(sql, con);
        ...
        private void del_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string sql = "DELETE FROM VisitTable WHERE ScheduleID = @sid";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.Parameters.AddWithValue("@sid", sid.Text);
        ...
        private void vetvetvis_Load(object sender, EventArgs e)
        {
            LoadData();
        }
    }
